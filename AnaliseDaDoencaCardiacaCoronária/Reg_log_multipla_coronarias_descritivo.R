...
data=read.csv2("D:/Glaucia/UTFPR_Cornelio/BIOINFO/curso_xmeeting_2024/programas e dados/dataset.csv",dec=".", sep=";")
#data=read.csv2("D:/Desktop/regressão/dataset.csv",dec=".", sep=";")
head(data)
attach(data)
names(data)
...
##############################################################
#################### STEP BY STEP ############################
##### Primeiro regressão logística simples ###################
##### E calculo dos odds ratio bruto #########################
##### Depois faremos o modelo de regressão logística múltiplo# 
##### Calculo do odds ratio ajustado #########################
##############################################################
##############################################################
...
##############################################################
##############################################################
##### Para a aula de hoje, escolheu-se um modelo etiológico (descritivo )
...
#Observe que as variáveis que passam pelo 1 são as que não rejeitaram H0
...
#não faz sentido assumir que os residuos da reg log seguem normal

##############################################################
####### Valor do critério de Akaike
md22$aic    #menor valor indica o melhor modelo

##############################################################
################# Multicolinearidade ###############

library(car) ### função esta nessa biblioteca
vif(md22)	 ### Não há colinearidade ViF<5 em todas as variáveis
